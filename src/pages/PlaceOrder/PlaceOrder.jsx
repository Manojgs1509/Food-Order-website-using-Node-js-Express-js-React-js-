...
import { StoreContext } from '../../components/Context/StroreContext'
import axios from 'axios'


const PlaceOrder = () => {
  const {getTotalAmountCart,url,token,food_list,cartItems,} =useContext(StoreContext)
    ...
    <form onSubmit={placeOrder}  className='place-order'>
         <div className='place-order-left'>
          ...
          <div className='cart-total'>
                   ...
                   <div className='cart-total-details'>
                    <b>Total</b>
                    <b>${ getTotalAmountCart() === 0 ? 0 : getTotalAmountCart()+2}</b>
